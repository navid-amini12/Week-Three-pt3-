...
// Below we will perform the same procedure using ternary statement
...
console.log(nameGreeting)
  ...
  */
      ...
      console.log(bestMovie("The Shawshank Redemption"))
...
function theEliminator([contestants],loser){
  ...
  var sampleString = 'Hi,my name is Kylo.'
  /*
    Write a function that takes in one argument, a string. The function should then console.log that string, in entirely uppercase characters.
    Invoke the function, passing in the sampleString (above).
  */
  function toUppderCase(sampleString){
    console.log(sampleString.toUpperCase());
  }
  toUppderCase(sampleString)
  ...
  */
    ...
    function emailCheck(email){
       ...
       return  "Not Verified"
        ...
        console.log(emailCheck("Amini.navid2000@gmail.com"))
  ...
  */
   ...
   function chocolatePrice(goldAmount){
    let chocolateNumber = goldAmount/3
   return chocolateNumber
   }
   console.log(chocolatePrice(4))
